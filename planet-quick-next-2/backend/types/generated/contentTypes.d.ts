...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    groupReuse: Schema.Attribute.Enumeration<['yes', 'no']>;
    groupTitle: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::event.event'> &
      Schema.Attribute.Private;
    location: Schema.Attribute.String;
    owner: Schema.Attribute.Relation<'oneToOne', 'api::event.event'>;
    publishedAt: Schema.Attribute.DateTime;
    shoppinglist: Schema.Attribute.Relation<
      'oneToOne',
      'plugin::users-permissions.user'
    >;
    state: Schema.Attribute.Enumeration<['pending', 'active', 'previous']>;
    time: Schema.Attribute.JSON;
...
export interface ApiGroupGroup extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    grade: Schema.Attribute.JSON;
    groupTitle: Schema.Attribute.String;
    grouptype: Schema.Attribute.JSON;
...
export interface ApiProductCatalogProductCatalog
  ...
  attributes: {
    approxPrice: Schema.Attribute.BigInteger;
    ...
    itemDescription: Schema.Attribute.String;
    lastSeen: Schema.Attribute.Date;
...
export interface ApiShoppingitemShoppingitem
  ...
  attributes: {
    ...
    shoppinglist: Schema.Attribute.Relation<'oneToOne', 'api::event.event'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiShoppinglistShoppinglist
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Relation<'oneToOne', 'api::event.event'>;
    ...
    owner: Schema.Attribute.Relation<'oneToOne', 'api::event.event'>;
    publishedAt: Schema.Attribute.DateTime;
    state: Schema.Attribute.Enumeration<['pending', 'active', 'purchased']>;
    title: Schema.Attribute.String;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    role: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.role'
    >;
    savedAddresses: Schema.Attribute.JSON;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    username: Schema.Attribute.String &
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::shoppingitem.shoppingitem': ApiShoppingitemShoppingitem;
